...
const RegisterPage = () => {
    ...
    return (
        <PageWrapper title="Register" description="Create a new httpstack account.">
                ...
                >
                    <Card className="bg-gray-900/50 backdrop-blur-md border-cyan-500/30">
                        <CardHeader className="text-center">
                            <CardTitle className="text-4xl font-bold text-white">Become a Specifier</CardTitle>
                            <CardDescription className="text-gray-300 mt-2">
                                Join us and start defining the future of tech stacks.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
